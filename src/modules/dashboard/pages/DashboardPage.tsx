...
const dashboardCardOrder = ['score', 'agenda', 'wellbeing', 'coach', 'details'] as const
...
export function DashboardPage() {
  ...
  const cards = {
    ...
    coach: <section aria-labelledby="coach-heading" key="coach"><SectionHeader description={`${data.insights.length} prioridade${data.insights.length === 1 ? '' : 's'} baseada em evidências`} id="coach-heading" title="Coach TITAN" /><CoachInsightsList insights={data.insights} /></section>,
